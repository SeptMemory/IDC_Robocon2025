# Guideline For the Online Teammate in **Team Khaki**
...
After the preparations above  for the robot model, you can start the simulation by controlling the spinning of the wheels and servos. The task for the Mission Robot to complete is clearly mentioned in the `Online Mode` part of [Rulebook](Rules_book_V20250811.pdf).
